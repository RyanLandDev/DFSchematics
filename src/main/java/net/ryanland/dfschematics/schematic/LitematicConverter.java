...
// Taken from https://github.com/GoldenDelicios/Lite2Edit, slightly modified by Ryan
public class LitematicConverter {

    // .litematic to .schem
    public static List<File> toWorldEdit(File inputFile, File outputDir) throws IOException {
